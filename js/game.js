...
var ExternalAPI = {
    ...
    loadData = {
        images: [
            ...
            ["btn_try_phb", "game_over/btn_try_phb.png"],
...
function goTo() {
    const result=gameScore.val;
    window.location.href="./phb.html?result="+result;
}
...
function showLoseScreen() {
    ...
    addSprite("btn_try_phb",173, 43, 160, 400, !0).onclick = goTo
}
